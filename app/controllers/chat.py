...
from ..services.chat import ChatValidationError, build_messages, sanitise_reply, validate_chat_input
...
@rate_limited(20, 60, key_func=lambda: f"user:{g.current_user.id}")
def chat():
    try:
